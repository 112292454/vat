...
def wrap_ass_text(
    text: str, max_width: int, font_name: str, font_size: int, spacing: float = 0.0, fonts_dir: Optional[str] = None
) -> str:
    """
    ...
    font = get_font(pil_font_size, font_name, fonts_dir=fonts_dir)
