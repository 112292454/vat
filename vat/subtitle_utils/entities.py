...
class ASROutputFormatEnum(Enum):
    """转录输出格式"""
...
class ASRConfig:
    ...
    asr_model: Optional[ASRModelEnum] = None
    asr_language: str = ""
    need_word_time_stamp: bool = True
    output_format: Optional[ASROutputFormatEnum] = None
    # Whisper Cpp 配置
    ...
    def print_config(self) -> str:
        ...
        lines.append(
            f"Model: {self.asr_model.value if self.asr_model else 'None'}"
        )
        lines.append(f"Language: {self.asr_language or 'Auto'}")
        ...
        if self.asr_model == ASRModelEnum.WHISPER_API:
        ...
        elif self.asr_model == ASRModelEnum.FASTER_WHISPER:
            lines.append(
        ...
        elif self.asr_model == ASRModelEnum.WHISPER_CPP:
            lines.append(
